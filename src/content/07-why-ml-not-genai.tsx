  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-center text-sm text-muted-foreground">
        It&apos;s precise, not a guess. Run it twice, get the same answer.
      </p>
    </div>
  );
}
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm leading-relaxed text-muted-foreground">
        ...
        transaction data. It has feedback loops — every outcome refines the next prediction.
        Generative AI (ChatGPT, etc.) is probabilistic: the same prompt can yield different answers.
        It has no access to your transaction history, no feedback mechanism, and no industry-specific
        training. For pricing, that&apos;s the difference between a recommendation you can act on and
        a suggestion you have to verify from scratch.
      </p>
    </div>
  );
}
